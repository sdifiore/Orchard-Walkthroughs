            ...
            orchardCoreAdminWalkthrough: new Shepherd.Tour({
                ...
                steps: [
                    ...
                    },
                    {
                        ...
                        id: 'roles_system_permissions',
                        when: {
                            show() {
                                addShepherdQueryParams();
                                setWalkthroughCookies(this.tour.options.id, 'roles_system_permissions');
                            },
                        },
                    },
                    {
                        title: 'Roles',
                        text: `<p>Let's see a role we can edit! The Authenticates role will be useful. Click on the
                            <em>"Edit"</em> button.</p>`,
                        attachTo: { element: 'li[data-filter-value="Authenticated"] .edit.btn.btn-primary.btn-sm', on: 'top' },
                        buttons: [
                            backButton,
                        ],
